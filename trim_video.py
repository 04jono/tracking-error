...
parser = argparse.ArgumentParser(description="Create n clips of 2 seconds each")
...
# Create n clips of 2 seconds each
for i in range(args.n):
    ...
    print(f"Created {output_file} (seconds {start_time}-{start_time+2})")
